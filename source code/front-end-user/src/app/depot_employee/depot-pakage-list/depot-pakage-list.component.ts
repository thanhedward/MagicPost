...
@Component({
  selector: 'app-depot-pakage-list',
  templateUrl: './depot-pakage-list.component.html',
  styleUrls: ['./depot-pakage-list.component.scss']
})
export class DepotPakageListComponent implements OnInit {
